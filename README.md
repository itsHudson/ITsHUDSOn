...
<table>
  <tr>
    <td width="120" align="center" valign="top">
      <br/>
      <img src="https://capsule-render.vercel.app/api?type=rect&color=0:0d0f1e,100:1e2540&height=90&width=90&text=CJH&fontSize=28&fontColor=a78bfa&animation=fadeIn" width="90" style="border-radius:10px"/>
      <br/>
      <sub><code>UID · HDS-2024</code></sub>
      <br/>
      <sub><code>CLEARANCE · ANALYST</code></sub>
    </td>
    <td valign="top" style="padding-left:16px">
      <h3>CHIA JIN HAU (HUDSON)</h3>
      CS undergrad specialising in <strong>Data Analytics</strong> at APU. Backed by <strong>6 years</strong> of real-world operations — data decisions that drove a <strong>25% revenue boost</strong>, cut costs <strong>12%</strong>, and lifted satisfaction by <strong>20%</strong>. Red Hat certified. Codes from Assembly to Python.
      <br/><br/>
      <table>
        <tr>
          <td><sub>🎓 <strong>DEGREE</strong></sub><br/><sub>BSc CS · Analytics</sub></td>
          <td><sub>📜 <strong>CERTIFIED</strong></sub><br/><sub>Red Hat Admin</sub></td>
          <td><sub>🗣️ <strong>SPOKEN</strong></sub><br/><sub>EN · BM · ZH · 粤</sub></td>
          <td><sub>✅ <strong>STATUS</strong></sub><br/><sub>Open to hire</sub></td>
        </tr>
      </table>
    </td>
  </tr>
...
<table>
  <tr>
    <td width="50%">
      <h4>🟣 Python — Classroom Mgmt System</h4>
      <p>Attendance tracking & schedule management with file I/O and modular design</p>
      <p><code>file I/O</code> <code>scheduling</code> <code>modular</code></p>
    </td>
    <td width="50%">
      <h4>🔵 Java — APU Medical Centre</h4>
      <p>OOP system with patient records, appointments & billing via inheritance</p>
      <p><code>OOP</code> <code>inheritance</code> <code>billing</code></p>
    </td>
  </tr>
  <tr>
    <td>
      <h4>🩷 C — Bus Reservation System</h4>
      <p>Seat reservation & cancellation using arrays, pointers and file I/O</p>
      <p><code>arrays</code> <code>pointers</code> <code>file I/O</code></p>
    </td>
    <td>
      <h4>🟡 Assembly — Shape Generation System</h4>
      <p>Geometric rendering using registers, loops and low-level memory ops</p>
      <p><code>registers</code> <code>loops</code> <code>memory</code></p>
    </td>
  </tr>
  <tr>
    <td>
      <h4>🟢 SAS — Education Domain EDA</h4>
      <p>Data cleaning & statistical modelling on education datasets in SAS Studio</p>
      <p><code>EDA</code> <code>data cleaning</code> <code>stats</code></p>
    </td>
    <td>
      <h4>🔴 Systems Design — Green Haven Resorts</h4>
      <p>SDLC Waterfall system with use-case & process diagrams</p>
      <p><code>SDLC</code> <code>waterfall</code> <code>UML</code></p>
    </td>
  </tr>
  <tr>
    <td colspan="2">
      <h4>🟠 Agile — APU TalentLink</h4>
      <p>Internship/job matching platform with sprints, user stories & UI/UX mockups</p>
      <p><code>agile</code> <code>UI/UX</code> <code>Figma</code></p>
    </td>
  </tr>
</table>
---
...
╠══════════════════════════════════════════════════════╣
║  ● kernel    ONLINE — all systems nominal            ║
║  ⚡ mission   seeking internship / data role          ║
║  ● degree    BSc CS · Data Analytics · APU           ║
